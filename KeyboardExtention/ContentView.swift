        ...
        NavigationView {
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    // Checklist
                    VStack(alignment: .leading, spacing: 12) {
                        checklistRow(title: "1. Install", detail: "Run app to install extension.")
                        checklistRow(title: "2. Add Keyboard", detail: "Settings > General > Keyboard > Add New Keyboard")
                        checklistRow(title: "3. Allow Full Access", detail: "Tap keyboard in list -> Toggle 'Allow Full Access'. REQUIRED for API.")
                        checklistRow(title: "4. Grant Mic", detail: "Click button below.")
                    }
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        statusRow(name: "Microphone", statusText: micStatusText, ok: micStatus == .granted)
                    }
